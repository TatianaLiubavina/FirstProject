...
export default function Home() {
  return (
    <div>
      ...
      <p>
        Здесь можно ознакомиться с резюме трех кандидатов на вакансию
        разработчика.
      </p>
      ...
      <p>
        Для получения дополнительной информации о кандидатах, пожалуйста,
        свяжитесь с нами.
      </p>
      ...
      <ul className="links__container">
        ...
        <li>
          Телефон: <a href="tel:+79213343345">+7 (921) 334-33-45</a>
        </li>
