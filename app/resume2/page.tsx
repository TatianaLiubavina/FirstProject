...
export default function Resume2() {
  return (
<div>
<Header title="Романова Анна Владимировна" subtitle="Ведущий разработчик React, NodeJs" photo={resumephoto2.src} />
<section className="links">
<h2 className="links__header">Контакты</h2>
<ul className="links__container">
<Contacts title="Phone number" subtitle="+7 (921) 334-33-45" link="tel:+79213343345" />
<Contacts title="Telegram" subtitle="@romanovaanna" link="https://t.me/romanovaanna" />
<Contacts title="Email" subtitle="romanovaanna@gmail.com" link="mailto:romanovaanna@gmail.com" />
<Contacts title="GitHub" subtitle="github.com/romanovaanna" link="https://github.com/romanovaanna" />
<Contacts title="LinkedIn" subtitle="Anna Romanova" link="https://www.linkedin.com/in/romanovaanna/" />
<Contacts title="Instagram" subtitle="instagram.com/romanovaanna" link="https://www.instagram.com/romanovaanna/" />
<Contacts title="Facebook" subtitle="Anna Romanova" link="https://www.facebook.com/romanovaanna" />
...
businessTypes={["Интернет-магазин"]}
