...
export default function Resume1() {
  return (
<div>
<Header pageTitle="Иванов Петр Владимирович" subtitle="Руководитель группы разработки" photo={resumephoto.src} />
...
<LocationsSection locations="Москва" relocation={["Нидерланды", "Австрия", "Чехия", "Люксембург", "Норвегия", "ОАЭ", "Бельгия", "Сербия", "Великобритания", "США", "Швеция", "Греция", "Германия", "Ирландия", "Финляндия", "Испания", "Италия", "Сингапур", "Швейцария", "Кипр", "Канада", "Португалия", "Венгрия", "Эквадор", "Лихтенштейн", "Хорватия", "Словения", "Уругвай", "Индонезия"]} relocation_bool={true} business_trips={true} />
...
<WorkSchedule businessTypes={["проектная работа", "частичная занятость", "полная занятость"]} workSchedule={["удаленная работа", "полный день"]} />
...
businessTypes={["Автозапчасти, шины (розничная торговля)", "Автокомпоненты, запчасти, шины (продвижение, оптовая торговля)", "Автокомпоненты, запчасти (производство)"]}
