export const resume1 = {
  pageTitle: "Иванов Петр Владимирович",
  subtitle: "Руководитель группы разработки",
  photo: "/resumephoto.webp",
  contacts: [
    {
      contactTitle: "Phone number",
      contactSubtitle: "+7 (921) 334-33-45",
      link: "tel:+79213343345",
    },
    {
      contactTitle: "Telegram",
      contactSubtitle: "@ivanovpetr",
      link: "https://t.me/ivanovpetr",
    },
    {
      contactTitle: "Email",
      contactSubtitle: "ivanovpetr@gmail.com",
      link: "mailto:ivanovpetr@gmail.com",
    },
    {
      contactTitle: "GitHub",
      contactSubtitle: "github.com/ivanovpetr",
      link: "https://github.com/ivanovpetr",
    },
    {
      contactTitle: "LinkedIn",
      contactSubtitle: "Petr Ivanov",
      link: "https://www.linkedin.com/in/ivanovpetr/",
    },
    {
      contactTitle: "Habr Career",
      contactSubtitle: "career.habr.com/ivanovpetr",
      link: "https://career.habr.com/ivanovpetr",
    },  
    {
      contactTitle: "Instagram",
      contactSubtitle: "ivanovpetr",
      link: "https://www.instagram.com/ivanovpetr/",
    },
    {
      contactTitle: "Facebook",
      contactSubtitle: "Petr Ivanov",
      link: "https://www.facebook.com/ivanovpetr",
    },
  ],
  telegramLink: "https://t.me/ivanovpetr",
  telegramUsername: "@ivanovpetr",
  ...
  social: [
    ...
    },
    {
      ...
      link: "https://twitter.com/ivanovpetr",
  ...
  business_trips: true,
  jobName: "Руководитель группы разработки PHP, NodeJs",
  jobTitles: [
    ...
    workSchedule: ["удаленная работа", "полный день"],
experiences: [
        {
keyName: "experience-section-1",
startDate: "Май 2021",
...
businessTypes: [
  ...
  "Автокомпоненты, запчасти (производство)",
    ...
    description: [
      "Управление разработкой собственных продуктов компании (внутренние сервисы, портала).",
      "Устранение проблем производительности и повышение отказоустойчивости продукта, рефакторинг, распил монолита, обертывание в Docker-контейнеры, подготовка к миграции в Kubernetes.",
      "Перевод старого Legacy недокументированного кода на микросервисную архитектуру.",
      "Система обслуживает более 500 поставщиков, более 100 брендов, более 31 000 000 SKU доступно для заказа, более 100 000 наименований товаров в постоянном наличии, более 20 000 клиентов.",
      "Планирование спринтов и основных приоритетов разработки, участие в совете архитекторов и релизном комитете.",
    ],
    techStack: [
        "php7",
        "php8",
        ...
        },
        {
          ...
          description: [
            ...
            "Участие в общении с бизнес-заказчиками, аналитиками, декомпозиции/постановке задач",
            "Участие в ведении технической документации",
            "Управление командой разработчиков 10+.",
          ],
        },
        {
          keyName: "experience-section-3",
          ...
          description: [
            ...
            "Делаем серверные, десктопные, мобильные приложения под любые платформы.",
            "Создаем сайты, интернет-магазины, веб-сервисы, Rest-Api, интеграции.",
          ],
        },
    ],
    experienceDuration: 12,
  skills: [
    "Adobe Photoshop",
            "ERP Systems",
            "HTML5",
  ...
  links: [
    ...
    "https://www.web-programming.com/",
    "https://www.project-management.com/",
    "https://www.git-scm.com/",
    "https://www.html.com/",
    "https://www.css.com/",
    "https://www.network-administration.com/",
    "https://www.sql.com/",
    "https://www.teamcenter.com/",
  ...
  education: [
    {
      ...
      date: "2010",
      university: "Балтийский государственный технический университет ВОЕНМЕХ им. Д.Ф. Устинова, Санкт-Петербург",
      specialization: "Аэрокосмический, Плазмогазодинамика и теплотехника",
    },
  ],
  alertText: "Что нас не убивает, делает нас сильнее!",
};