export const resume2 = {
    pageTitle: "Романова Анна Владимировна",
    subtitle: "Ведущий разработчик React, NodeJs",
    photo: "/resumephoto2.webp",
    contacts: [
      {
      ...
      },
      {
        ...
        contactSubtitle: "@romanovaanna",
        link: "https://t.me/romanovaanna",
      },
      {
        contactTitle: "Email",
        contactSubtitle: "romanovaanna@gmail.com",
        link: "mailto:romanovaanna@gmail.com",
      },
      {
        contactTitle: "GitHub",
        contactSubtitle: "github.com/romanovaanna",
        link: "https://github.com/romanovaanna",
      },
      {
        contactTitle: "LinkedIn",
        contactSubtitle: "Anna Romanova",
        link: "https://www.linkedin.com/in/romanovaanna/",
      },
      {
        contactTitle: "Instagram",
        contactSubtitle: "instagram.com/romanovaanna",
        link: "https://www.instagram.com/romanovaanna/",
      },
      {
        contactTitle: "Facebook",
        contactSubtitle: "Anna Romanova",
        link: "https://www.facebook.com/romanovaanna",
      },
    ],
    telegramLink: "https://t.me/romanovaanna",
    telegramUsername: "@romanovaanna",
    ...
    jobName: "Ведущий разработчик React, NodeJs",
    jobTitles: [
      "Ведущий разработчик React, NodeJs",
      "Разработчик React, NodeJs",
      "Разработчик NextJs",
      "Разработчик React Native",
    ],
    businessTypes: ["проектная работа", "частичная занятость"],
    ...
    experiences: [
      {
        ...
        description: [
          "Разработка и поддержка собственных продуктов компании (внутренние сервисы, портала).",
      ...
      },
      {
        ...
        description: [
          ...
          "Разработка и поддержка проектов заказчиков, аутстаффинг.",
    ...
    education: [
      {
        ...
        date: "2014",
        university: "Национальный исследовательский университет информационных технологий, механики и оптики, Санкт-Петербург",
        specialization: "Информационные системы и технологии",
      },
      {
        education: "Профессиональная переподготовка",
        date: "2017",
        university: "Национальный исследовательский университет информационных технологий, механики и оптики, Санкт-Петербург",
        specialization: "Иностранные языки",
      },
    ],
    alertText: "Лучше сделать и пожалеть, чем не сделать и пожалеть.",
  };