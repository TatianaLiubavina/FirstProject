...
export default function Slider() {
  ...
  const slideLeft = () => {
    let slider = document.getElementsByClassName(".slider-block1");
    const element = slider[0]; // Выбираем первый элемент
    element.scrollLeft = element.scrollLeft - 235;
  };
    ...
    <div className="slider">
      <div className="slider-block">
        ...
        <div className="slider-block2">
          <button className="button button-prev" onClick={slideLeft}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <button className="button button-next" onClick={slideRight}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
