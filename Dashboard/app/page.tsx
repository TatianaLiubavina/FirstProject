...
import TableCustomersPagination from "./components/TableCustomersPagination";
      ...
      <nav>
        <div className="nav-position-block">
          <div className="nav-dashboard">
            ...
            <h1 className="nav-dashboard-text">Dashboard</h1>
            <p className="nav-version">v.01</p>
          </div>
          ...
          <div className="gradient-window">
            <p className="gradient-window-text">
              Upgrade to PRO to get access all Features!
            </p>
            <button className="gradient-window-button">Get Pro Now!</button>
          </div>
          <div className="user-profile">
            <Image
              src="/image/3389ec299edb640f65b7cb2d606c9ae4d3bd74e2.png"
              alt="Evano"
      ...
      <div className="main-block">
        ...
        <div className="earning">
          <div className="earning-block">
            <div className="earning-block-svg">
              <svg
                width="42"
                height="42"
                viewBox="0 0 42 42"
            ...
            <div className="visitors-block">
              <p className="visitors">Total Customers</p>
              <p className="visitors-number">5,423</p>
              <div className="visitors-percent">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                ...
                <p>
                  <span className="visitors-percent-color-green">16%</span> this
                  month
                </p>
              </div>
            </div>
          ...
          <div className="earning-block">
            ...
            <div className="visitors-block">
              <p className="visitors">Members</p>
              <p className="visitors-number">1,893</p>
              <div className="visitors-percent">
                <svg
                  width="20"
                  height="20"
                ...
                <p>
                  <span className="visitors-percent-color-red">1% </span>this
                  month
                </p>
              </div>
            </div>
          ...
          <div className="earning-block">
            ...
            <div className="visitors-block">
              <p className="visitors">Active Now</p>
              <p className="visitors-number">189</p>
              <div className="card-avatars">
                <Image
                  src="/image/05cf540ef9953449a469d519cab6d0aed5e02023.png"
                  alt="avatar"
                  width={300}
                  height={300}
                />
                <Image
                  src="/image/48656e67f608b1d5690d7ec662fed11cb629f12f.png"
                  alt="avatar"
                  width={300}
                  height={300}
                />
                <Image
                  src="/image/f1e5ca1e9f301eeb05909330a86655a0825d815b.png"
                  alt="avatar"
                  width={300}
                  height={300}
                />
                <Image
                  src="/image/641af5b774441983aebe2f1293d1cfc74e01f3f6.png"
                  alt="avatar"
                  width={300}
                  height={300}
                />
                <Image
                  src="/image/528b66a1780fa57e3e657fcf2fb4c9c4744320bf.png"
                  alt="avatar"
                  width={300}
                  height={300}
                />
